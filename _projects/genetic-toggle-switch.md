...
excerpt: "Modeling bistability in a synthetic gene circuit through ODE simulation, bifurcation analysis, and stochastic noise modeling."
image: /assets/images/toggle-switch-project_phase_portrait.png
---
## Project Overview
...
![Phase Portrait]({{ site.baseurl }}/assets/images/toggle-switch-project_phase_portrait.png)
...
![Bifurcation Diagram]({{ site.baseurl }}/assets/images/toggle-switch-project_bifurcation_diagram.png)
...
![Stochastic Population]({{ site.baseurl }}/assets/images/toggle-switch-project_stochastic_population.png)
